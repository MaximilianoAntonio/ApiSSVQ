...
# Force HTTPS in REST Framework pagination URLs
...
MIDDLEWARE = [
    ...
    'gestor_vehiculos.middleware.ForceHTTPSMiddleware',
    'gestor_vehiculos.middleware.APISecurityMiddleware',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'asignaciones.pagination.HTTPSPageNumberPagination',
    'PAGE_SIZE': 10
}
